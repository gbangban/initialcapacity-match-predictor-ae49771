...
from matchpredictor.predictors.regression_experiments_predictor import train_experiments_predictor
...
def build_model_provider(training_data: List[Result]) -> ModelProvider:
    ...
    return ModelProvider([
        ...
        Model("Offense simulator (fast)", train_offense_predictor(training_data, 10)), #edit Shrunken for speed...
        Model("Offense simulator", train_offense_predictor(training_data, 10)),
        Model("Full simulator (fast)", train_offense_and_defense_predictor(training_data, 10)),
        Model("Full simulator", train_offense_and_defense_predictor(training_data, 10)),
        ...
        Model("Regression experiments", train_experiments_predictor(training_data)),
